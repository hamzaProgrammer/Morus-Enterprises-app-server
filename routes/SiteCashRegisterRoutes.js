...
router.put('/api/sitesCashRegisters/getCashHistoryOfASite/:id/:owner', getHistoryOfCashGiven)

// updating cash of site
router.put('/api/sitesCashRegisters/updateCashOfSite/:id/:owner', updateCashOfSite)

// getting history of cash given to a site
router.put('/api/sitesCashRegisters/getCashHistoryOfASiteByManager/:id/:manager', getHistoryOfCashGivenByManager)
